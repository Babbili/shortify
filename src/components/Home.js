    ...
    return (
        <section className="home">
            <svg
                ...
                height="435.00015"
                viewBox="0 0 498 437">
                <defs><linearGradient id="aa" x1="0%" x2="100%" y1="50%" y2="50%"><stop offset="0%" stopColor="#183866" /><stop offset="100%" stopColor="#1A7FC1" /></linearGradient><linearGradient id="bb" x1="-.13%" x2="100%" y1="50.057%" y2="50.057%"><stop offset="0%" /><stop offset="99%" stopOpacity="0" /></linearGradient><linearGradient id="cc" x1="176.072%" x2="310.393%" y1="-566.037%" y2="-534.629%"><stop offset="0%" /><stop offset="99%" stopOpacity="0" /></linearGradient><linearGradient id="dd" x1="58.928%" x2="52.269%" y1="-257.998%" y2="-277.344%"><stop offset="0%" /><stop offset="99%" stopOpacity="0" /></linearGradient><linearGradient id="ee" x1="156.099%" x2="8.109%" y1="-63.273%" y2="-76.114%"><stop offset="0%" /><stop offset="99%" stopOpacity="0" /></linearGradient><linearGradient id="ff" x1="2361.044%" x2="2162.651%" y1="-16584.906%" y2="-16647.547%"><stop offset="0%" /><stop offset="99%" stopOpacity="0" /></linearGradient><linearGradient id="gg" x1="241.391%" x2="133.142%" y1="-426.052%" y2="-412.195%"><stop offset="0%" /><stop offset="99%" stopOpacity="0" /></linearGradient><linearGradient id="hh" x1="106.85%" x2="-35.821%" y1="22.502%" y2="19.27%"><stop offset="0%" /><stop offset="100%" stopOpacity="0" /></linearGradient><linearGradient id="ii" x1="14.169%" x2="114.168%" y1="-41.335%" y2="-41.335%"><stop offset="0%" stopColor="#183866" /><stop offset="100%" stopColor="#1A7FC1" /></linearGradient><linearGradient id="jj" x1="40.386%" x2="71.43%" y1="39.515%" y2="67.977%"><stop offset="0%" /><stop offset="99%" stopOpacity="0" /></linearGradient><linearGradient id="kk" x1="-12.531%" x2="93.689%" y1="44.923%" y2="53.42%"><stop offset="0%" /><stop offset="99%" stopOpacity="0" /></linearGradient><linearGradient id="ll" x1="53.702%" x2="43.721%" y1="42.271%" y2="80.595%"><stop offset="0%" /><stop offset="99%" stopOpacity="0" /></linearGradient><linearGradient id="mm" x1="190.926%" x2="102.154%" y1="-333.246%" y2="-335.028%"><stop offset="0%" /><stop offset="99%" stopOpacity="0" /></linearGradient><linearGradient id="nn" x1="168.578%" x2="111.53%" y1="-126.252%" y2="-126.942%"><stop offset="0%" /><stop offset="99%" stopOpacity="0" /></linearGradient><linearGradient id="oo" x1="56.989%" x2="28.128%" y1="43.618%" y2="69.958%"><stop offset="0%" /><stop offset="99%" stopOpacity="0" /></linearGradient><linearGradient id="pp" x1="58.095%" x2="57.212%" y1="-1473.571%" y2="-1370.204%"><stop offset="0%" /><stop offset="99%" stopOpacity="0" /></linearGradient><linearGradient id="qq" x1="-.04%" x2="99.996%" y1="49.993%" y2="49.993%"><stop offset="0%" stopColor="#ECC4D7" /><stop offset="42%" stopColor="#EFD4D1" /><stop offset="100%" stopColor="#F2EAC9" /></linearGradient><linearGradient id="rr" x1="99.032%" x2="199.03%" y1="-163.287%" y2="-163.287%"><stop offset="0%" stopColor="#ECC4D7" /><stop offset="42%" stopColor="#EFD4D1" /><stop offset="100%" stopColor="#F2EAC9" /></linearGradient><linearGradient id="ss" x1="124.306%" x2="224.306%" y1="-84.564%" y2="-84.564%"><stop offset="0%" stopColor="#ECC4D7" /><stop offset="42%" stopColor="#EFD4D1" /><stop offset="100%" stopColor="#F2EAC9" /></linearGradient><linearGradient id="tt" x1="128.89%" x2="24.06%" y1="100.36%" y2="153.095%"><stop offset="0%" stopColor="#362958" stopOpacity=".501" /><stop offset="100%" stopColor="#34313D" stopOpacity="0" /></linearGradient><linearGradient id="uu" x1="3990.942%" x2="3874.36%" y1="-34225.187%" y2="-34268.317%"><stop offset="0%" /><stop offset="99%" stopOpacity="0" /></linearGradient>
                </defs>
                <g
                    fill="none"
                    fillRule="nonzero"
                    id="g223"
                    transform="translate(4.0003185,-9.9999555)">
                    <path
                        fill="var(--body-color-alt-a)"
                        d="M 389.80262,75.490956 C 375.81721,60.563989 364.99125,42.744984 348.27584,30.563351 322.02012,11.38935 284.23292,9.519561 253.53278,21.56516 c -30.70081,12.044933 -54.61663,36.324844 -70.37981,63.817538 -8.29201,14.464852 -14.80493,30.243362 -26.95523,42.063572 -10.27116,9.98643 -23.77112,16.35798 -36.5709,23.29767 -20.63702,11.15805 -40.5112,24.64067 -53.866447,43.14051 -13.353918,18.49984 -19.324705,42.79708 -10.78796,63.64616 5.756735,14.06809 17.352225,25.26148 29.231117,35.39595 13.9794,11.91557 29.00439,23.07295 46.34462,30.17268 21.70862,8.83282 45.80715,10.73195 69.43957,11.63083 41.89553,1.58706 83.85842,0.40077 125.57657,-3.54953 34.16165,-3.23012 69.35756,-8.74413 97.93985,-26.59314 40.03841,-24.99542 60.68144,-70.79257 65.32924,-115.7015 1.89112,-17.96171 1.41234,-36.62759 -5.97746,-53.29298 -17.67363,-39.863036 -65.36058,-30.53943 -93.05399,-60.101964 z"
                        id="path115"
                        strokeWidth="0.666829" />
                    <path
                        fill="var(--body-color-alt-d)"
                    ...
                    <circle
                        ...
                        fill="#25233a"
                        id="circle125" />
                    <path fill="url(#aa)" d="M214 384.5a5.5 5.5 0 11-11 0 5.5 5.5 0 0111 0z" />
                    <circle
                        cx="207"
                        cy="399"
                        r="11"
                    ...
                    <path
                        ...
                        id="path213" />
                    <path fill="url(#tt)" d="M469.804 212.337l-142.25 7.655c-3.44.177-6.372-2.478-6.554-5.934V112.473c-.004-4.102 3.26-7.452 7.342-7.535l141.68-2.937c3.777-.07 6.898 2.943 6.978 6.738v95.977c-.005 4.057-3.164 7.403-7.196 7.621z" />
                    <path
                        fill="#3a3054"
            ...
            <div className="home__content">
                <h1 className="home__content__title">More than just shorter links</h1>
                <p className="home__content__description">
                    Build your brand’s recognition and get detailed insights on how your links are performing
                </p>
                <a className="button" href="#shorten">Get<span className="space">Started</span></a>
            </div>
        </section>
    )
}
